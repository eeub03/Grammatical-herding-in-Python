...
class Grammar(object):
    ...
    def __init__(self, file_name):
        ...
        self.start_rule, self.codon_size = None, par.params['CODON_SIZE']
    ...
    def check_permutations(self):
        ...
        ramps = par.params['PERMUTATION_RAMPS']
    ...
    def get_min_ramp_depth(self):
        ...
        max_tree_depth = par.params['MAX_INIT_TREE_DEPTH']
        size = par.params['POPULATION_SIZE']
        ...
        unique_start = int(math.floor(size / len(depths)))
        ramp = None
